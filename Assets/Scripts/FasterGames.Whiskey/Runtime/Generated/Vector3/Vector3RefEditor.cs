...
#if UNITY_EDITOR
/// <summary>
/// Custom PropertyDrawer for <see cref="RefMutableVector3"/>s and <see cref="RefImmutableVector3"/>s
/// </summary>
[UnityEditor.CustomPropertyDrawer(typeof(RefMutableVector3))]
[UnityEditor.CustomPropertyDrawer(typeof(RefImmutableVector3))]
public class Vector3RefEditor : UnityEditor.PropertyDrawer
{
