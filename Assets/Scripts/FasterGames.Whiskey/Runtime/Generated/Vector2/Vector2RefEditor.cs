...
#if UNITY_EDITOR
/// <summary>
/// Custom PropertyDrawer for <see cref="RefMutableVector2"/>s and <see cref="RefImmutableVector2"/>s
/// </summary>
[UnityEditor.CustomPropertyDrawer(typeof(RefMutableVector2))]
[UnityEditor.CustomPropertyDrawer(typeof(RefImmutableVector2))]
public class Vector2RefEditor : UnityEditor.PropertyDrawer
{
